 <div class="row justify-content-between mt-2">
    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="btn-group btn-block m-1 " role="group" aria-label="Basic example">
            <button type="button" class="btn btn-sm m-0 btn-secondary" data-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-sm m-0 btn-success mr-1">Save</button>
        </div>
    </div>
</div>